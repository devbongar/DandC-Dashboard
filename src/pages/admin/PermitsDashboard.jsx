...
export default function PermitsDashboard() {
  ...
  return (
    <AdminLayout title="Permits Monitoring" actions={headerActions} mobileActionsRow={mobileSearchRow} mobileTitleActions={mobileTitleActionsBtn} mobileBg="linear-gradient(180deg, #555555 0%, #909090 100%)">
