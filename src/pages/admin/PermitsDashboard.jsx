...
export default function PermitsDashboard() {
  ...
  return (
    <AdminLayout title="Permits Monitoring" actions={headerActions} mobileActionsRow={mobileSearchRow} mobileTitleActions={mobileTitleActionsBtn} mobileBg="linear-gradient(180deg, #c94040 0%, #ed6055 100%)">
