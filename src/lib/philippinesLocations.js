...
export const PH_CITIES = {
  ...
  'Bohol': [
    ...
    'Batuan', 'Bien Unido', 'Bilar', 'Buenavista', 'Calape', 'Catigbian',
    'Clarin', 'Corella', 'Cortes', 'Dagohoy', 'Danao', 'Dauis', 'Dimiao',
    'Duero', 'Garcia Hernandez', 'Guindulman', 'Inabanga', 'Jagna', 'Jetafe',
    'Lila', 'Loay', 'Loboc', 'Loon', 'Mabini', 'Maribojoc', 'Panglao',
    'Pilar', 'Pres. Carlos P. Garcia', 'Sagbayan', 'San Isidro', 'San Miguel',
    'Sevilla', 'Sierra Bullones', 'Sikatuna', 'Tagbilaran City', 'Talibon',
  ...
  'Bulacan': [
    ...
    'Doña Remedios Trinidad', 'Guiguinto', 'Hagonoy', 'Marilao', 'Malolos City',
  ...
  'Cotabato (North Cotabato)': [
    ...
    'Kabacan', 'Kidapawan City', 'Libungan', 'Magpet', 'Makilala', 'Matalam',
    'Midsayap', 'Mlang', 'Munai', 'Pigcawayan', 'Pikit', 'President Roxas',
    'Tulunan',
  ],
  'Davao de Oro': [
  ...
  'Davao del Norte': [
    ...
    'Panabo City', 'San Isidro', 'Santo Tomas', 'Tagum City', 'Talaingod',
    'Island Garden City of Samal',
  ],
  'Davao del Sur': [
    'Bansalan', 'Davao City', 'Digos City', 'Don Marcelino', 'Hagonoy',
  ...
  'Ifugao': [
    'Alfonso Lista', 'Asipulo', 'Banaue', 'Hingyon', 'Hungduan', 'Kiangan',
  ...
  'Isabela': [
    ...
    'Echague', 'Gamu', 'Ilagan City', 'Jones', 'Luna', 'Maconacon', 'Mallig',
  ...
  'Kalinga': [
    'Balbalan', 'Lubuagan', 'Pasil', 'Pinukpuk', 'Rizal', 'Tabuk City', 'Tanudan',
    'Tinglayan',
  ],
  'La Union': [
  ...
  'Lanao del Sur': [
    ...
    'Bubong', 'Bumbaran', 'Butig', 'Calanogas', 'Ditsaan-Ramain', 'Ganassi',
    'Kapai', 'Kapatagan', 'Lumba-Bayabao', 'Lumbaca-Unayan', 'Lumbatan', 'Lumbayanague',
    'Madalum', 'Madamba', 'Maguing', 'Malabang', 'Marantao', 'Marawi City',
    'Marogong', 'Masiu', 'Mulondo', 'Pagayawan', 'Piagapo', 'Picong', 'Poona Bayabao',
    'Pualas', 'Saguiaran', 'Sultan Dumalondong', 'Tamparan', 'Taraka', 'Tubaran',
    'Tugaya', 'Wao',
  ],
  'Leyte': [
    ...
    'San Miguel', 'Santa Fe', 'Silvino Lobos', 'Tabango', 'Tabontabon',
    'Tacloban City', 'Tanauan', 'Tolosa', 'Tunga', 'Villaba',
  ],
  'Maguindanao del Norte': [
    'Datu Blah T. Sinsuat', 'Datu Odin Sinsuat', 'Kabuntalan', 'Kotabato City',
    'Midsayap', 'Northern Kabuntalan', 'Parang', 'Sultan Kudarat', 'Sultan Mastura',
    'Upi',
  ],
  'Maguindanao del Sur': [
    'Ampatuan', 'Barira', 'Buldon', 'Buluan', 'Datu Abdullah Sangki', 'Datu Anggel Insular',
    'Datu Hoffer Ampatuan', 'Datu Paglas', 'Datu Piang', 'Datu Saudi-Ampatuan',
    'Datu Unsay', 'Gen. Salipada K. Pendatun', 'Guindulungan', 'Mamasapano',
    'Mangudadatu', 'Paglat', 'Pandag', 'Rajah Buayan', 'Shariff Aguak',
    'Shariff Saydona Mustapha', 'South Upi', 'Sultan sa Barongis', 'Talayan',
  ],
  'Marinduque': [
  ...
  'Negros Occidental': [
    'Bacolod City', 'Binalbagan', 'Cadiz City', 'Calatrava', 'Candoni', 'Cauayan',
    'Enrique B. Magalona', 'Escalante City', 'Himamaylan City', 'Hinigaran',
  ...
  'Negros Oriental': [
    'Ayungon', 'Bacong', 'Bais City', 'Basay', 'Bayawan City', 'Bindoy',
  ...
  'Northern Samar': [
    ...
    'Laoang', 'Lapinig', 'Las Navas', 'Lavezares', 'Lope de Vega', 'Mapanas',
    'Mondragon', 'Palapag', 'Pambujan', 'Rosario', 'San Antonio', 'San Isidro',
  ...
  'Nueva Ecija': [
    ...
    'Santo Domingo', 'Science City of Muñoz', 'Talavera', 'Talugtug', 'Zaragoza',
  ],
  'Nueva Vizcaya': [
  ...
  'Palawan': [
    ...
    'El Nido', 'Española', 'Kalayaan', 'Linapacan', 'Magsaysay', 'Narra',
    'Puerto Princesa City', 'Quezon', 'Rizal', 'Roxas', 'San Vicente',
  ...
  'Pangasinan': [
    ...
    'Rosales', 'San Carlos City', 'San Fabian', 'San Jacinto', 'San Manuel',
    'San Nicolas', 'San Quintin', 'Santa Barbara', 'Santa Maria', 'Santo Tomas',
    'Sison', 'Sual', 'Tayug', 'Umingan', 'Urbiztondo', 'Urdaneta City',
    'Villasis',
  ],
  'Quezon': [
  ...
  'Samar (Western Samar)': [
    ...
    'Gandara', 'Hinabangan', 'Jiabong', 'Langkag', 'Lawaan', 'Marabut',
    'Matuguinao', 'Motiong', 'Pagsanghan', 'Paranas', 'Pinabacdao', 'San Jorge',
    'San Jose de Buan', 'San Sebastian', 'Santa Margarita', 'Santa Rita',
    'Santo Niño', 'Tagapul-an', 'Talalora', 'Tarangnan', 'Tinambacan',
  ...
  'South Cotabato': [
    ...
    'Polomolok', 'Santo Niño', 'Surallah', 'T\'boli', 'Tampakan', 'Tantangan',
    'Tupi',
  ],
  'Southern Leyte': [
    'Anahawan', 'Bontoc', 'Hinunangan', 'Hinundayan', 'Libagon', 'Liloan',
    'Limasawa', 'Maasin City', 'Macrohon', 'Malitbog', 'Padre Burgos',
  ...
  'Sulu': [
    'Hadji Panglima Tahil', 'Indanan', 'Jolo', 'Kalingalan Caluang', 'Languyan',
  ...
  'Surigao del Norte': [
    ...
    'San Francisco', 'San Isidro', 'Santa Monica', 'Sison', 'Socorro', 'Surigao City',
    'Tagana-an', 'Tubod',
  ],
  'Surigao del Sur': [
  ...
  'Zamboanga del Norte': [
    ...
    'Manukan', 'Mutia', 'Piñan', 'Polanco', 'Pres. Manuel A. Roxas', 'Rizal',
    'Salug', 'San Miguel', 'Sergio Osmeña Sr.', 'Siayan', 'Sibuco', 'Sibutad',
  ...
  'Zamboanga del Sur': [
    ...
    'Ramon Magsaysay', 'San Miguel', 'San Pablo', 'Tabina', 'Tambulig',
